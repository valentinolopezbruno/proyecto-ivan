...
function App() {
  return (
    <div className="App">
               ...
               <a className="a-header" href="#"><img className="logo" src="./img/6.png" alt="keepbox"/></a>
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cart" viewBox="0 0 16 16">
                            ...
                            <div className="search-container">
                              <form action="/action_page.php">
                                ...
                                <button className="buscar" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" className="bi bi-search" viewBox="0 0 16 16">
...
<h3 className="titulo-destacados">Accesorios</h3>
<div className="scroll-contenedor">
<div className="scroll">
  <div className="producto">
    <img src="./img/magsafe.png" alt=""/>
...
<h3 className="titulo-destacados">Airpods</h3>
<div className="scroll-contenedor">
<div className="scroll">
  <div className="producto">
...
<h3 className="titulo-destacados">Watch</h3>
<div className="scroll-contenedor">
<div className="scroll">
  <div className="producto">
    <img src="./img/watch.png" alt=""/>
